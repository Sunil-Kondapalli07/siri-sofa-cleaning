/**
 * Siri Sofa Services — Premium Motion Hero & 3D Spatial Presentation
 */

const HeroComponent = {
  render() {
    return `
      <!-- 1. Hero Section with 3D Spatial Multi-Plane Depth -->
      <section class="relative pt-8 pb-16 lg:pt-14 lg:pb-24 overflow-hidden bg-[#FAF9F6] hero-spatial-container">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div class="lg:col-span-6 space-y-7 text-left spatial-depth-1">
              ...
              <p class="hero-subtitle max-w-lg leading-relaxed font-medium text-[#4A5568]">
                Professional sofa and chair deep extraction cleaning, delivered directly to your doorstep. Hospital-grade fabric sanitization eliminating deep stains, odors, and 99.9% of dust mites.
              </p>

              <!-- CTA Actions -->
              <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-2">
                <button onclick="store.setView('book')" class="btn-primary text-sm py-3.5 px-8 group shadow-lg">
            ...
            <!-- Right Column: 3D Spatial Layered Showcase Card -->
            <div class="lg:col-span-6 relative hero-floating-main-card">
              <div class="relative rounded-3xl overflow-hidden shadow-2xl border border-black/8 bg-white group">
                ...
                <div class="w-full h-[460px] sm:h-[500px] relative overflow-hidden">
                  <img src="images/hero_luxury_sofa.jpg" alt="Restored Luxury Emerald Velvet Sofa - Siri Sofa Services" class="w-full h-full object-cover object-center transform group-hover:scale-103 transition-transform duration-700 ease-out">
                  
                  <!-- Soft Vignette & Gradient Overlays -->
                  <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent pointer-events-none"></div>

                  <!-- 3D Floating Top Right Badge -->
                  <div class="absolute top-4 right-4 z-20 bg-white/95 backdrop-blur-md px-3.5 py-1.5 rounded-full shadow-lg border border-black/5 flex items-center gap-2 text-[11px] font-bold text-[#0C4A34] hero-floating-glass-badge">
                    <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                    <span>99.9% Sanitized</span>
                  </div>

                  <!-- 3D Floating Top Left Process Pill -->
                  <div class="absolute top-4 left-4 z-20 bg-[#0C4A34]/90 backdrop-blur-md px-3.5 py-1.5 rounded-full shadow-lg text-[11px] font-bold text-white flex items-center gap-2 hero-floating-glass-badge">
                    <span>✨ High-Extraction Steam</span>
                  </div>

                  <!-- 3D Floating Glass Card Overlay (Bottom) -->
                  <div class="absolute bottom-5 left-5 right-5 z-20 glass-card rounded-2xl p-4 sm:p-5 shadow-2xl text-left border border-white/70 spatial-depth-2">
      ...
      <!-- 2. How It Works Section (4-Step 3D Tilt Timeline) -->
      <section class="py-16 lg:py-24 bg-[#FAF9F6] border-t border-black/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <!-- 4-Step 3D Tilt Cards with Dynamic Glare -->
      ...
      <!-- 3. Why Choose Siri Section (Interactive 3D Cards) -->
      <section class="py-16 lg:py-24 bg-[#F4F2EC] border-t border-black/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Feature 1 -->
            <div class="why-card bg-white p-7 rounded-2xl border border-black/5 shadow-xs hover:border-[#0C4A34]/25 transition-all">
  ...
  initViewer() {
    // Notify 3D engine to re-scan elements if needed
    if (window.spatial3DEngine) {
      window.spatial3DEngine.refreshElements();
    }
  },
