...
import { Heart, ShieldCheck, Sparkles, AlertCircle, CheckCircle2, ArrowRight } from "lucide-react";
...
export const EmotionalStory: React.FC<EmotionalStoryProps> = ({ onBookNow }) => {
  return (
    <section className="py-20 lg:py-28 bg-[#FAF9F6] border-t border-black/5 overflow-hidden">
