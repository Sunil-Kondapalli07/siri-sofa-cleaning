...
import { CheckCircle2, ShieldCheck, Sparkles, Wind, Droplets, Clock, ArrowRight } from "lucide-react";
...
export const HygieneProcess: React.FC = () => {
  ...
  return (
    <section id="hygiene" className="py-20 lg:py-28 bg-[#F4F2EC] border-t border-black/5">
